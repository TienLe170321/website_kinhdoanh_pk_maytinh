...
<div class="row mx-auto w-75 p-3 bg-white shadow m-3">
	...
	<div class="col-6 ">
		<div class="border bg-light m-2">
			<p class="  text-info text-center">Thông tin phụ kiện</p>
		...
		<form class="border bg-light m-2" action="http://localhost/<?php echo link;?>/Cart/Add_Gear/" method="post">
			<p class="  text-info text-center">Thêm vào giỏ hàng</p>
			<div class="row shadow-sm p-2 m-2  bg-white ">
				<label for="sl " class="w-25 ">Số lượng :</label>
				<input class=" col- 4 w-25" type="number" name="sl" value="1" min="1" max="10">
			</div>
